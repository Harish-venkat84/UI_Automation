...
public class Rw_SupplierRackReturnWithSaleCloseThisPackSizeDis extends Common_Methods {
	...
	public void user_need_to_provide_the_disposition_for_selected_line_item() throws Exception{
		...
		waitElementToCickable(pageobject.getRw_SupplierReturn().getSaleclosesthispackSizeDisposition());
		click(pageobject.getRw_SupplierReturn().getSaleclosesthispackSizeDisposition());
	}
