...
public class RW_CreateGDNWithGRNAndLostInTransistDis extends Common_Methods{
	...
	public void user_need_to_switch_appropriate_fc_using_fc_switcher_to_create_gdn_for_lost_in_transist_disposition() throws InterruptedException, IOException, ConfigurationException {
	...
	public void user_need_to_get_into_the_supplier_gdn_page_for_lost_in_transist_disposition() throws InterruptedException {
	...
	@When("User need to select the import supplierGDN for Lost in Transist Disposition")
	public void user_need_to_select_the_import_supplier_gdn_for_lost_in_transist_disposition() {
	...
	@When("User need to select the correct file for Lost in Transist Disposition")
	public void user_need_to_select_the_correct_file_for_lost_in_transist_disposition() throws InterruptedException, AWTException, IOException {
	...
	@When("User need to upload the selected file for GDN for Lost in Transist Disposition")
	public void user_need_to_upload_the_selected_file_for_gdn_for_lost_in_transist_disposition() throws InterruptedException {

		Thread.sleep(1000);
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getUploadfile());
	}

	@When("User need to close the import GRN page by clicking cross mark for Lost in Transist Disposition")
	public void user_need_to_close_the_import_grn_page_by_clicking_cross_mark_for_lost_in_transist_disposition() throws InterruptedException {
		
		Thread.sleep(1000);
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getCloseImportGRN());
	}

	@When("User need to close the GDN page for Lost in Transist Disposition")
	public void user_need_to_close_the_gdn_page_for_lost_in_transist_disposition() {
	...
	public void user_need_to_get_into_the_supplier_grn_page_for_lost_in_transist_disposition() {
	...
	public void user_need_to_provide_the_supplier_name_in_supplier_invoice_details_for_lost_in_transist_disposition() throws IOException, InterruptedException {
	...
	@When("User need to provide the supplier invoice number and clikc the suggestion For Lost in Transist Disposition")
	public void user_need_to_provide_the_supplier_invoice_number_and_clikc_the_suggestion_for_lost_in_transist_disposition() throws InterruptedException, IOException {
	...
	@When("User need to select supply type by clicking check box For Lost in Transist Disposition")
	public void user_need_to_select_supply_type_by_clicking_check_box_for_lost_in_transist_disposition() {
	...
	@When("User need to click the proceed button For Lost in Transist Disposition")
	public void user_need_to_click_the_proceed_button_for_lost_in_transist_disposition() throws InterruptedException {
	...
	@When("User need to provide the disposition for all given items For Lost in Transist Disposition")
	public void user_need_to_provide_the_disposition_for_all_given_items_for_lost_in_transist_disposition() {
		...
		waitElementTovisibility(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getLineItemOneLostInTransist());
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getLineItemOneLostInTransist());
		
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getSelectDisposition2());
		waitElementTovisibility(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getLineItemTwoLostInTransist());
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getLineItemTwoLostInTransist());
		...
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getLineItemThreeLostInTransist());
	}

	@When("User need to provide the supplier bill amount For Lost in Transist Disposition")
	public void user_need_to_provide_the_supplier_bill_amount_for_lost_in_transist_disposition() throws Exception {
	...
	@When("User need to click the submit button For Lost in Transist Disposition")
	public void user_need_to_click_the_submit_button_for_lost_in_transist_disposition() throws InterruptedException {
	...
	@When("User need to click the upload supplier invoice scan copies For Lost in Transist Disposition")
	public void user_need_to_click_the_upload_supplier_invoice_scan_copies_for_lost_in_transist_disposition() {
	...
	@When("User need to select the appropriate file For Lost in Transist Disposition")
	public void user_need_to_select_the_appropriate_file_for_lost_in_transist_disposition() throws Exception {
	...
	@When("User need to upload the selected file For Lost in Transist Disposition")
	public void user_need_to_upload_the_selected_file_for_lost_in_transist_disposition() throws InterruptedException {
	...
	@When("User need to verify scan copy with GRN entry totals and line item entries For Lost in Transist Disposition")
	public void user_need_to_verify_scan_copy_with_grn_entry_totals_and_line_item_entries_for_lost_in_transist_disposition() {
	...
	@When("User need to approve the supplier invoice For Lost in Transist Disposition")
	public void user_need_to_approve_the_supplier_invoice_for_lost_in_transist_disposition() {
	...
	@When("User need to close the supplier invoice page For Lost in Transist Disposition")
	public void user_need_to_close_the_supplier_invoice_page_for_lost_in_transist_disposition() throws InterruptedException {
	...
	@When("User need to capture the Txn Id for further process For Lost in Transist Disposition")
	public void user_need_to_capture_the_txn_id_for_further_process_for_lost_in_transist_disposition() throws ConfigurationException, IOException {
	...
	@When("user need to close the supplier GRN page For Lost in Transist Disposition")
	public void user_need_to_close_the_supplier_grn_page_for_lost_in_transist_disposition() {
	...
	//Vendor Margin variance Detected verification

	@Given("User need to provide the GRN transaction id in transaction field For Lost in Transist Disposition")
	public void user_need_to_provide_the_grn_transaction_id_in_transaction_field_for_lost_in_transist_disposition() throws IOException {
	...
	public void user_need_to_search_grn_using_the_transection_id_for_lost_in_transist_disposition() {
	...
	@When("User need to click the edit icon for the GRN verification For Lost in Transist Disposition")
	public void user_need_to_click_the_edit_icon_for_the_grn_verification_for_lost_in_transist_disposition() {
	...
	@When("User need to Allow Intransit Lost or Damage by clicking Yes button for Lost in Transist Disposition")
	public void user_need_to_allow_intransit_lost_or_damage_by_clicking_yes_button_for_lost_in_transist_disposition() {
	...
	@When("User need to confirm Lost in Transit, Damage in Transit disposition will not added in inventory by clicking Yes for Lost in Transist Disposition")
	public void user_need_to_confirm_lost_in_transit_damage_in_transit_disposition_will_not_added_in_inventory_by_clicking_yes_for_lost_in_transist_disposition() {
	...
	@When("User need to click the I verify button for vendor margin approve For Lost in Transist Disposition")
	public void user_need_to_click_the_i_verify_button_for_vendor_margin_approve_for_lost_in_transist_disposition() {
	...
	@When("User need to click the Approve GRN For Lost in Transist Disposition")
	public void user_need_to_click_the_approve_grn_for_lost_in_transist_disposition() throws InterruptedException {
	...
	@When("User need to close the current GRN page For Lost in Transist Disposition")
	public void user_need_to_close_the_current_grn_page_for_lost_in_transist_disposition() {
	...
	public void user_need_to_provide_the_grn_transaction_id_in_transaction_field_for_gstin_number_verification_for_lost_in_transist_disposition() throws Exception{
	...
	public void user_need_to_search_grn_for_gstin_verification_for_lost_in_transist_disposition() {
	...
	@When("User need to click the edit icon for GSTIN number verification For Lost in Transist Disposition")
	public void user_need_to_click_the_edit_icon_for_gstin_number_verification_for_lost_in_transist_disposition() {
	...
	@When("User need to click the I verify button GSTIN number verification For Lost in Transist Disposition")
	public void user_need_to_click_the_i_verify_button_gstin_number_verification_for_lost_in_transist_disposition() {
	...
	@When("User need to verify the GSTIN number and click verify button For Lost in Transist Disposition")
	public void user_need_to_verify_the_gstin_number_and_click_verify_button_for_lost_in_transist_disposition() {
	...
	@When("User need to click the submit and print label For Lost in Transist Disposition")
	public void user_need_to_click_the_submit_and_print_label_for_lost_in_transist_disposition() throws InterruptedException {
	...
	@When("User need to close the current GSTIN verification page For Lost in Transist Disposition")
	public void user_need_to_close_the_current_gstin_verification_page_for_lost_in_transist_disposition() {
	...
	public void user_need_to_provide_the_grn_transaction_id_in_transaction_field_for_for_putaway_process_for_lost_in_transist_disposition() throws Exception{
	...
	public void user_need_to_search_grn_for_putaway_process_for_lost_in_transist_disposition() {

		waitElementToCickable(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getClickSearchGSTIN());
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getClickSearchPutAway());
	}

	@When("User need to click the edit icon for for putaway process For Lost in Transist Disposition")
	public void user_need_to_click_the_edit_icon_for_for_putaway_process_for_lost_in_transist_disposition() {

		waitElementToCickable(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getClickEditIconGSTIN());
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getClickEditIconPutAway());
	}

	@When("User need to click putaway done by clicking Yes For Lost in Transist Disposition")
	public void user_need_to_click_putaway_done_by_clicking_yes_for_lost_in_transist_disposition() throws InterruptedException {
	...
	@When("User need to click the submit button for putaway process For Lost in Transist Disposition")
	public void user_need_to_click_the_submit_button_for_putaway_process_for_lost_in_transist_disposition() throws InterruptedException {
	...
	@When("User need to close the putaway process page For Lost in Transist Disposition")
	public void user_need_to_close_the_putaway_process_page_for_lost_in_transist_disposition() {
