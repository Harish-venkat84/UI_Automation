...
public class RW_CreateGDNWithGRNAndWrongBatchDis  extends Common_Methods {
	...
	public void user_need_to_get_into_the_supplier_grn_page_for_wrong_batch_disposition() {
	...
	public void user_need_to_provide_the_supplier_name_in_supplier_invoice_details_for_wrong_batch_disposition() throws Exception{
	...
	@When("User need to provide the supplier invoice number and clikc the suggestion for Wrong Batch Disposition")
	public void user_need_to_provide_the_supplier_invoice_number_and_clikc_the_suggestion_for_wrong_batch_disposition() throws Exception{
	...
	@When("User need to select supply type by clicking check box for Wrong Batch Disposition")
	public void user_need_to_select_supply_type_by_clicking_check_box_for_wrong_batch_disposition() {
	...
	@When("User need to click the proceed button for Wrong Batch Disposition")
	public void user_need_to_click_the_proceed_button_for_wrong_batch_disposition() throws Exception{
		Thread.sleep(2000);
	...
	@When("User need to provide the disposition for all given items for Wrong Batch Disposition")
	public void user_need_to_provide_the_disposition_for_all_given_items_for_wrong_batch_disposition() {
		...
		waitElementTovisibility(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getLineItemOneWrongBatch());
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getLineItemOneWrongBatch());
		
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getSelectDisposition2());
		waitElementTovisibility(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getLineItemTwoWrongBatch());
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getLineItemTwoWrongBatch());
		
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getSelectDisposition3());
		waitElementTovisibility(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getLineItemThreeWrongBatch());
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getLineItemThreeWrongBatch());
	}

	@When("User need to provide the supplier bill amount for Wrong Batch Disposition")
	public void user_need_to_provide_the_supplier_bill_amount_for_wrong_batch_disposition() throws Exception{
	...
	@When("User need to click the submit button for Wrong Batch Disposition")
	public void user_need_to_click_the_submit_button_for_wrong_batch_disposition() {
	...
	@When("User need to click the upload supplier invoice scan copies for Wrong Batch Disposition")
	public void user_need_to_click_the_upload_supplier_invoice_scan_copies_for_wrong_batch_disposition() throws Exception{
	...
	@When("User need to select the appropriate file for Wrong Batch Disposition")
	public void user_need_to_select_the_appropriate_file_for_wrong_batch_disposition() throws Exception{
	...
	@When("User need to upload the selected file for Wrong Batch Disposition")
	public void user_need_to_upload_the_selected_file_for_wrong_batch_disposition() throws Exception{
	...
	@When("User need to verify scan copy with GRN entry totals and line item entries for Wrong Batch Disposition")
	public void user_need_to_verify_scan_copy_with_grn_entry_totals_and_line_item_entries_for_wrong_batch_disposition() {
	...
	@When("User need to approve the supplier invoice for Wrong Batch Disposition")
	public void user_need_to_approve_the_supplier_invoice_for_wrong_batch_disposition() {
	...
	@When("User need to close the supplier invoice page for Wrong Batch Disposition")
	public void user_need_to_close_the_supplier_invoice_page_for_wrong_batch_disposition() throws Exception{
	...
	@When("User need to capture the Txn Id for further process for Wrong Batch Disposition")
	public void user_need_to_capture_the_txn_id_for_further_process_for_wrong_batch_disposition() throws Exception{
	...
	@When("user need to close the supplier GRN page for Wrong Batch Disposition")
	public void user_need_to_close_the_supplier_grn_page_for_wrong_batch_disposition() {
	...
	public void user_need_to_provide_the_grn_transaction_id_in_transaction_field_for_wrong_batch_disposition() throws Exception{
	...
	public void user_need_to_search_grn_using_the_transection_id_for_wrong_batch_disposition() {
	...
	@When("User need to click the edit icon for the GRN verification for Wrong Batch Disposition")
	public void user_need_to_click_the_edit_icon_for_the_grn_verification_for_wrong_batch_disposition() {
	...
	@When("User need to click the I verify button for vendor margin approve for Wrong Batch Disposition")
	public void user_need_to_click_the_i_verify_button_for_vendor_margin_approve_for_wrong_batch_disposition() {
	...
	@When("User need to click the Approve GRN for Wrong Batch Disposition")
	public void user_need_to_click_the_approve_grn_for_wrong_batch_disposition() throws Exception{
	...
	@When("User need to close the current GRN page for Wrong Batch Disposition")
	public void user_need_to_close_the_current_grn_page_for_wrong_batch_disposition() {
	...
	public void user_need_to_provide_the_grn_transaction_id_in_transaction_field_for_gstin_number_verification_for_wrong_batch_disposition() throws Exception{
	...
	public void user_need_to_search_grn_for_gstin_verification_for_wrong_batch_disposition() {
	...
	@When("User need to click the edit icon for GSTIN number verification for Wrong Batch Disposition")
	public void user_need_to_click_the_edit_icon_for_gstin_number_verification_for_wrong_batch_disposition() {
	...
	@When("User need to click the I verify button GSTIN number verification for Wrong Batch Disposition")
	public void user_need_to_click_the_i_verify_button_gstin_number_verification_for_wrong_batch_disposition() {
	...
	@When("User need to verify the GSTIN number and click verify button for Wrong Batch Disposition")
	public void user_need_to_verify_the_gstin_number_and_click_verify_button_for_wrong_batch_disposition() {
	...
	@When("User need to click the submit and print label for Wrong Batch Disposition")
	public void user_need_to_click_the_submit_and_print_label_for_wrong_batch_disposition() throws Exception{
	...
	@When("User need to close the current GSTIN verification page for Wrong Batch Disposition")
	public void user_need_to_close_the_current_gstin_verification_page_for_wrong_batch_disposition() {
	...
	public void user_need_to_provide_the_grn_transaction_id_in_transaction_field_for_for_putaway_process_for_wrong_batch_disposition() throws Exception{
	...
	public void user_need_to_search_grn_for_putaway_process_for_wrong_batch_disposition() {

		waitElementToCickable(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getClickSearchGSTIN());
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getClickSearchPutAway());
	}

	@When("User need to click the edit icon for for putaway process for Wrong Batch Disposition")
	public void user_need_to_click_the_edit_icon_for_for_putaway_process_for_wrong_batch_disposition() {

		waitElementToCickable(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getClickEditIconGSTIN());
		click(pageobject.getRW_CreateGDNWithGRNAndDemagedDis().getClickEditIconPutAway());
	}

	@When("User need to click putaway done by clicking Yes for Wrong Batch Disposition")
	public void user_need_to_click_putaway_done_by_clicking_yes_for_wrong_batch_disposition() throws Exception{
		Thread.sleep(2000);
	...
	@When("User need to click the submit button for putaway process for Wrong Batch Disposition")
	public void user_need_to_click_the_submit_button_for_putaway_process_for_wrong_batch_disposition() throws Exception{
		Thread.sleep(2000);
	...
	@When("User need to close the putaway process page for Wrong Batch Disposition")
	public void user_need_to_close_the_putaway_process_page_for_wrong_batch_disposition() {
